...
const zhTW: Dict = {
  ...
  testimonials: {
    ...
    name_a: "L 小姐",
    occ_b: "舊金回收",
    quote_b: "店裡有越南店員,從進門到結帳全程越南話溝通。金價怎麼算、純度怎麼驗,她都用我聽得懂的話講一遍。兩條金鍊回收,當天就拿到現金。",
    name_b: "Ms. Nguyễn",
    occ_c: "訂婚對戒",
...
const en: Dict = {
  ...
  testimonials: {
    ...
    name_a: "Ms. L",
    occ_b: "Gold buy-back",
    quote_b: "They have a Vietnamese-speaking staff member. From walking in to checkout, everything was in Vietnamese — how the gold price is calculated, how purity is tested, all in my own language. Brought two chains; cash on the spot the same day.",
    name_b: "Ms. Nguyễn",
...
const vi: Dict = {
  ...
  testimonials: {
    ...
    name_a: "Cô L",
    occ_b: "Thu mua vàng",
    quote_b: "Tiệm có nhân viên người Việt. Từ lúc bước vào đến lúc thanh toán, mọi thứ đều bằng tiếng Việt — cách tính giá vàng, cách kiểm tra độ tinh khiết, đều bằng tiếng tôi hiểu. Mang 2 sợi dây vàng — nhận tiền mặt ngay trong ngày.",
    name_b: "Cô Nguyễn",
...
const id: Dict = {
  ...
  testimonials: {
    ...
    quote_b: "Toko ini punya staf yang bisa berbahasa Vietnam. Dari masuk sampai bayar semua dijelaskan dalam bahasa Vietnam — cara menghitung harga emas, cara cek kemurnian, semua dengan bahasa yang saya pahami. Bawa dua kalung — tunai langsung hari itu juga.",
    name_b: "Bu Nguyễn",
...
const fil: Dict = {
  ...
  testimonials: {
    ...
    quote_b: "May staff silang nagsasalita ng Vietnamese sa tindahan. Mula pagpasok hanggang pagbayad, lahat ay sa Vietnamese — kung paano kinakalkula ang presyo ng ginto, kung paano sinusuri ang kadalisayan, lahat sa wikang naiintindihan ko. Dalawang kuwintas ang dinala ko — cash agad sa parehong araw.",
    name_b: "Bb. Nguyễn",
  ...
  contact: {
    ...
    line_value: "Idagdag bilang Kaibigan",
    ig_value: "@shiny_gold991",
    fb_value: "Shiny Gold / Taoyuan",
...
const th: Dict = {
  ...
  testimonials: {
    ...
    name_a: "คุณ L",
    occ_b: "รับซื้อทอง",
    quote_b: "ที่ร้านมีพนักงานพูดภาษาเวียดนาม ตั้งแต่เข้าจนชำระเงิน ทุกอย่างเป็นภาษาเวียดนาม วิธีคิดราคาทอง วิธีตรวจความบริสุทธิ์ ทั้งหมดเป็นภาษาที่ฉันเข้าใจ เอาสร้อยสองเส้นไป — รับเงินสดวันเดียวกัน",
    name_b: "คุณเหงียน",
    occ_c: "แหวนหมั้น",
