...
const en: Dict = {
  ...
  contact: {
    ...
    line_value: "@ official ID pending",
    ig_value: "@shiny_gold991",
...
const vi: Dict = {
  ...
  contact: {
    ...
    line_value: "@ ID chính thức sắp cập nhật",
    ig_value: "@shiny_gold991",
...
const fil: Dict = {
  ...
  contact: {
    ...
    line_value: "@ official ID susunod",
    ig_value: "@shiny_gold991",
    fb_value: "Shiny Gold / Taoyuan",
    cta_call: "Tumawag",
    cta_map: "Direksyon →",
...
const th: Dict = {
  ...
  contact: {
    ...
    line_value: "@ ID อย่างเป็นทางการเร็ว ๆ นี้",
    ig_value: "@shiny_gold991",
    fb_value: "Shiny Gold / Taoyuan",
    cta_call: "โทร",
    cta_map: "เส้นทาง →",
